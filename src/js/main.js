...
var audioPlayer = function() {
  ...
  var onLoad = function(currentTrack, playListRows) {
    console.log('here')
    ...
    var initTrackSubTitleBox = document.querySelector(".player .info-box .track-info-box .track-subtitle-text");
    var initTrackSuperTitle = _elements.playListRows[0].children[2].children[0].attributes[3].textContent;

    if (initTrackSuperTitle !== "null" || initTrackSuperTitle === null) {
  ...
  var _setTrackTitle = function(currentTrack, playListRows) {
    ...
    var trackSubTitleBox = document.querySelector(".player .info-box .track-info-box .track-subtitle-text");
    var trackSuperTitle = playListRows[currentTrack - 1].children[2].children[0].attributes[3].textContent;

    var articleUrlBox = document.querySelector(".player .info-box .track-info-box .track-article-url");
    var articleUrl = playListRows[currentTrack - 1].children[2].children[0].attributes[4].textContent;

    trackTitleBox.innerHTML = null;
    trackTitleBox.innerHTML = trackTitle;

    if (trackSuperTitle !== "null" || trackSuperTitle === null) {
      trackSubTitleBox.innerHTML = trackSuperTitle;
    } else {
      trackSubTitleBox.innerHTML = 'Die Nachrichten';
    }

    if (articleUrl !== "null" || articleUrl === null) {
      articleUrlBox.href = articleUrl;
      //articleUrlBox.href="http://www.stackoverflow.com";
    } else {
      articleUrlBox.href = '#';
    }
